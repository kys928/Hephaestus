...
def summarize_scorecards(
    ...
    *,
    ...
    return {
        ...
        "overall_quality_100": overall["quality_100"],
        "schema_compliance": overall["schema_compliance"],
        "evidence_grounding": overall["evidence_grounding"],
        "interface_invariant_pass_rate": overall["interface_invariant_pass_rate"],
        "deterministic_boundary_pass_rate": overall["deterministic_boundary_pass_rate"],
        "consumer_exact_contract_pass_rate": overall["consumer_exact_contract_pass_rate"],
